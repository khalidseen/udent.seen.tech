-- المرحلة الثانية: إكمال إعداد النظام الهرمي للأدوار

-- 1. إنشاء جدول التسلسل الهرمي للأدوار في العيادات
...
-- 2. إدراج البيانات الأساسية للتسلسل الهرمي
...
-- 3. إضافة عمود لتتبع دور المستخدم الحالي في العيادة (إذا لم يكن موجوداً)
DO $$ 
BEGIN
...
-- 4. دالة للتحقق من صلاحيات إدارة الأدوار
...
-- 5. دالة للحصول على دور المستخدم في العيادة
...
-- 6. دالة للتحقق من صلاحيات العيادة
...
-- 7. تحديث RLS policies لضمان الفصل بين العيادات
...
-- 8. إضافة policy لإدارة أعضاء العيادة حسب التسلسل الهرمي
...
-- 9. إضافة RLS على جدول clinic_role_hierarchy
...
-- 10. منع حذف آخر مالك في العيادة
