-- إنشاء الصلاحيات مستندة إلى الأقسام في القائمة الجانبية
DELETE FROM public.role_permissions;
DELETE FROM public.permissions WHERE category IN ('main_menu', 'ai_features', 'staff_management', 'financial_management', 'inventory_management', 'system_management', 'advanced_features');
