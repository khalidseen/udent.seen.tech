...
const roles: RoleInfo[] = [
  ...
  },
  {
    ...
    role_name_ar: 'مدير العيادة',
    description: 'إدارة شاملة للعيادة مع صلاحيات محدودة',
    permissions: ['إدارة المرضى', 'إدارة المواعيد', 'الإدارة المالية', 'إدارة المخزون', 'إدارة الأطباء والموظفين', 'التقارير الإدارية', 'إعدادات العيادة المحدودة']
  },
  {
    role_name: 'doctor',
    role_name_ar: 'طبيب',
