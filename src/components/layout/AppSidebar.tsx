...
export function AppSidebar() {
  ...
  const hasActiveInGroup = (items: typeof mainMenuItems) => 
          ...
          <div className="mb-4">
            <div className="relative">
              ...
              <Input
                ...
                className="pr-10 bg-sidebar-background/50 border-sidebar-border text-sidebar-foreground placeholder:text-sidebar-foreground/50"
              />
            </div>
          </div>
        )}
